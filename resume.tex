...
\textit{Tech \& Tools: Archimate, TOGAF, ADM, BDD, DDD, AWS, Kafka, Go, Graph, SQL ,Terraform}
...
\textit{Tech \& Tools: Laravel, Terraform, AWS, Apollo, Go, Rust, Node, React, PHP, SQL, Kafka, Python}
...
\textit{Tech \& Tools: React, Flask, DynamoDB, Jenkins, BigCommerce, Java, Python}
...
\textit{Tech \& Tools: Gatsby, Contentful, React, Node, Sass, Graphql, Netlify, Vercel}
...
\textit{Tech \& Tools: ReactJS, NodeJs, Mongo, Adobe Connect, Mysql, PHP, Golang}
...
\cvevent{Workshop Assistant, Python Developer }{Cake Creative Digital Lab}{Feb 2015-- May 2015}{Kuala Lumpur, Malaysia}
