...
\cvevent{Solution Architect}{Idexx Laboratories}{Sep 2021 -- Current}{Auckland, New Zealand}
...
\textit{Tech \& Tools: Archimate, TOGAF, ADM, BDD, DDD, AWS, Kafka, Go, Graph, SQL ,Terraform, Kubernetes, Elasticsearch, Redpanda}
...
\textit{Tech \& Tools: Laravel, Terraform, AWS, Apollo, Go, Rust, Node, React, PHP, SQL, Kafka, Python, Kubernetes, Elasticsearch, Redpanda}
...
\end{itemize}
  ...
  \textit{Tech \& Tools: React, AWS, Go, Laravel, Kubernetes, Terraform, PHP, Node}

  \divider



\cvevent{Frontend Developer}{Infosys}{Feb 2020 -- Jul 2020}{Auckland, New Zealand}
