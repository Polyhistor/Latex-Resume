...
\name{Dr. Pouya Ataei}
\tagline{AI Research Leader \& Computer Scientist (PhD in Big Data)}
...
\begin{raggedright}
  I am a Computer Scientist with a PhD in Big Data and 13+ years of experience bridging cutting-edge 
  research with practical product implementation. My doctoral research focused on distributed systems 
  and AI architectures, resulting in multiple peer-reviewed publications at prestigious conferences 
  including AMCIS, ACIS, and APSEC. As Principal Data Engineer at Vector, I currently lead the 
  development of large-scale ML models for energy analytics and demand forecasting.
  
  \vspace{0.5cm}
  Throughout my career, I've successfully transitioned from hands-on research to leading teams of 35+ 
  engineers, always maintaining a balance between scientific rigor and practical impact. I'm passionate 
  about coaching researchers, translating academic breakthroughs into scalable solutions, and have 
  extensive experience with neural architectures, distributed training, and model deployment at scale.
\end{raggedright}
...
- Leading and mentoring world-class research scientists

- Bridging foundational model innovation with product impact

- Contributing to the global AI community through publications

- Hands-on involvement in cutting-edge AI research

- Collaborative environment fostering scientific excellence

- Opportunity to shape research strategy and vision
...
\cvsection[\faCode]{Technical \& Research Expertise}
...
\begin{paracol}{2}
  \cvskill{Python}{4.5}
  \divider
  \cvskill{TensorFlow/PyTorch}{4}
  \divider
  \cvskill{Generative AI (GANs, Diffusion)}{4}
  \divider
  \cvskill{VAEs \& Autoregressive Models}{3.5}
  \divider
  \cvskill{Deep Learning}{4.5}
  \divider
  \cvskill{Machine Learning}{4.5}
  \divider
  \cvskill{Distributed Training}{4}
  \divider
  \cvskill{Model Optimization}{4}
  \divider
  \cvskill{Scientific Computing (NumPy, SciPy)}{4.5}
  \divider
  \cvskill{Research Methodology}{4.5}
  \divider
  \cvskill{Big Data \& Analytics}{4.5}
  \divider
  \cvskill{Data Engineering}{4}
  \divider
  \cvskill{Team Leadership}{4.5}
  \divider

  \switchcolumn
  \cvskill{Research Mentorship}{4.5}
  \divider
  \cvskill{AWS/GCP for ML}{4.5}
  \divider
  \cvskill{Kubernetes/Docker}{4}
  \divider
  \cvskill{MLOps \& Model Deployment}{4}
  \divider
  ...
  \divider
  \cvskill{Academic Writing}{4.5}
  \divider
  \cvskill{Conference Presentations}{4.5}
  \divider
  \cvskill{Cross-functional Collaboration}{4.5}
  \divider
  \cvskill{Product-Research Translation}{4}
  \divider
...
\textbf{\faBook~Book}
\begin{itemize}
  \item Ataei, P. (2017). \textit{The Nexus Methodology: A Trenchant Approach Toward Big Data}. LAP LAMBERT Academic Publishing.
\end{itemize}

\divider

\textbf{\faFile*[regular]~Journal Articles}
\begin{itemize}
  \item Ataei, P. (2024). Cybermycelium: a reference architecture for domain-driven distributed big data systems. \textit{Frontiers in Big Data}, 7, 1448481.
  \item Ataei, P., Regula, S., Haertel, C., \& Staegemann, D. (2024). Impact of big data analytics on business performance: A systematic literature review. \textit{International Journal of Information Management}.
  \item Ataei, P., Regula, S., \& Staegemann, D. (2024). Filtering Useful App Reviews Using Naive Bayes—Which Naive Bayes? \textit{AI}, 5(4), 2237-2259.
  \item Atemkeng, M., Hamlomo, S., Welman, B., Oyetunji, N., Ataei, P., \& Fendji, J. L. K. (2024). Ethics of Software Programming with Generative AI. \textit{arXiv preprint arXiv:2408.10554}.
  \item Ataei, P., \& Staegemann, D. (2023). Application of microservices patterns to big data systems. \textit{Journal of Big Data}, 10(1), 1-49.
  \item Ataei, P., \& Litchfield, A. (2022). The state of big data reference architectures: a systematic literature review. \textit{IEEE Access}.
  \item Bashari Rad, B., \& Ataei, P. (2017). The big data ecosystem and its environs. \textit{International Journal of Computer Science and Network Security}, 17(3), 38.
  \item Bashari Rada, B., Ataeib, P., Khakbizc, Y., \& Akbarzadehd, N. (2017). The hype of emerging technologies: Big data as a service. \textit{International Journal of Control Theory Applications}, 9(43), 1-18.
  \item Bashari Rad, B., Akbarzadeh, N., Ataei, P., \& Khakbiz, Y. (2016). Security and privacy challenges in big data era. \textit{International Journal of Control Theory and Applications}, 9(43), 437-448.
  \item Bashari Rad, B., \& Ataei, P. (2017). Evaluating Major Issues Regarding Reliability Management for Cloud-based Applications. \textit{International Journal of Computer Science and Network Security}, 17(7), 168.
\end{itemize}

\divider

\textbf{\faUsers~Conference Proceedings}
\begin{itemize}
  \item Ataei, P., Thorpe, S., Regula, S., \& Staegemann, D. (2024). Why Big Data Projects Fail? A Systematic Literature Review. \textit{ICICT 2024}.
  \item Ataei, P., \& Litchfield, A. (2023). Towards a domain-driven distributed reference architecture for big data systems. \textit{AMCIS 2023}.
  \item Ataei, P., \& Litchfield, A. (2021). NeoMycelia: A software reference architecture for big data systems. \textit{28th Asia-Pacific Software Engineering Conference (APSEC)}, 452-462.
  \item Ataei, P., \& Litchfield, A. (2020). Big Data Reference Architectures: A Systematic Literature Review. \textit{31st Australasian Conference on Information Systems (ACIS)}, 1-11.
  \item Staegemann, D., Ataei, P., et al. (2024). An Overview on Testing Big Data Applications. \textit{Ninth International Congress on Information and Communication Technology}, Lecture Notes in Networks and Systems.
\end{itemize}
