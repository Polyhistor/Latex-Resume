...
\name{Dr. Pouya Ataei}
\tagline{Principal Data Engineer \& Computer Scientist (PhD in Big Data)}
...
\begin{raggedright}
  ...
  designed and implemented high-performance systems serving millions of users. I have developed expertise in 
...
\begin{paracol}{2}
  \cvskill{AI \& Machine Learning}{4.5}
  \divider
  \cvskill{RAG}{4}
  \divider
  \cvskill{Vector Databases}{4.5}
  \divider
  \cvskill{LLMs \& Embeddings}{4}
  \divider
  \cvskill{Big Data }{4.5}
  \divider
  \cvskill{Data Engineering}{4}
  \divider
  \cvskill{TensorFlow/PyTorch}{3.5}
  \divider
  \cvskill{NLP \& Computer Vision}{3.5}
  \divider
  \cvskill{Python}{4.5}
  \divider
  \cvskill{AI Algorithms \& Neural Networks}{4}
  \divider
  \cvskill{SQL/NoSql}{4}
  \divider
  \cvskill{ES, MongoDB, Pinecone}{4}
  \divider
  \cvskill{Kafka/Redpanda}{4}
  \divider
  \cvskill{AWS}{4.5}
  \divider
  \cvskill{MLOps \& Model Deployment}{3.5}
  \divider
...
\cvevent{Principal Data \& AI Engineer}{Vector Limited}{May 2025 -- Current}{Auckland, New Zealand}
...
\begin{itemize}
  ...
  \item Developed cutting-edge algorithms for detecting electricity infrastructure by analyzing and extracting insights from scientific papers, applying advanced NLP and machine learning techniques to automate infrastructure identification.
  \item Created the company's first comprehensive MLOps pattern and framework, establishing standardized practices for model deployment, monitoring, and lifecycle management across the organization.
  \item Successfully implemented the MLOps framework for Vector's first North American client, demonstrating scalable AI/ML operations and setting the foundation for international expansion.
  \item Drive AWS cloud cost efficiency through best practices in Glue, Athena, S3, DynamoDB, and event-driven architectures, with specialized expertise in Athena query optimization and data engineering workflows.
  \item Architect complex data reconciliation systems that ensure data consistency and integrity across multiple heterogeneous data sources, handling petabyte-scale energy datasets.
  \item Design and scale Vector's data platform to support both real-time and batch energy analytics with a focus on performance, security, and cost-efficiency, leveraging advanced data engineering principles.
...
\textit{Tech \& Tools: AWS (Lambda, DynamoDB, S3, Glue, Athena), Python, Serverless Architecture, Data Engineering, Machine Learning, CI/CD, Event-Driven Architecture, Data Science, MLOps, NLP, Terraform, Docker, Kubernetes, Kafka, Vector Databases, TensorFlow}
