...
\cvsection[\faSearch]{Peer Review Service}
...
\begin{itemize}
  \item IEEE Transactions on Knowledge and Data Engineering (TKDE) \hfill 5 reviews
  \item Nature Communications (Springer Nature) \hfill 1 review
  \item ACM Transactions on Software Engineering \& Methodology (TOSEM) \hfill 1 review
  \item Expert Systems with Applications (Elsevier) \hfill 1 review
  \item Knowledge-Based Systems (Elsevier) \hfill 1 review
  \item Applied Soft Computing (Elsevier) \hfill 1 review
  \item Data \& Knowledge Engineering (Elsevier) \hfill 1 review
  \item IEEE Access \hfill 1 review
  \item Journal of Systems \& Software (Elsevier) \hfill 1 review
  \item Systems Engineering (Wiley) \hfill 4 reviews
\end{itemize}

\vspace{0.2cm}
\textbf{Conferences:}
\begin{itemize}
  \item ICSE 2025 - International Conference on Software Engineering (Program Committee)
