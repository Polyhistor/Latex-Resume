...
\begin{raggedright}
Invited reviewer for international journals (13+ reviews completed, 2023--2024):

\vspace{0.3cm}
\begin{itemize}
  \item \textbf{IEEE Transactions on Knowledge and Data Engineering (TKDE)}\\
        Premier IEEE journal for data engineering \hfill 4 reviews
  \item \textbf{Nature Communications}\\
        High-impact multidisciplinary journal (Springer Nature) \hfill 1 review
  \item \textbf{Data \& Knowledge Engineering (Elsevier)}\\
        Leading journal in data and knowledge systems \hfill 1 review
  \item \textbf{Systems Engineering (Wiley)}\\
        Systems engineering and design research \hfill 4 reviews
  \item \textbf{MDPI Sustainability}\\
        Open access journal on sustainability science \hfill 1 review
  \item \textbf{Frontiers in Psychology}\\
        Open access psychology research \hfill 1 review
  \item \textbf{Journal of Advanced Materials}\\
        Materials science research \hfill 1 review
\end{itemize}
\end{raggedright}
