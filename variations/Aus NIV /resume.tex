...
\begin{itemize}
  \item Architect critical serverless infrastructure for Blue Current (National Electricity Market partner), processing 2 billion daily data intervals from 2.7 million smart meters to support grid stability.
  \item Develop machine learning models for Proactive Power Safety Shutoff (PSPS) mapping in California (San Diego), applying adaptive algorithms to optimize grid resilience and wildfire mitigation.
...
\begin{itemize}
  ...
  \item Served as the principal architect for the entire 'Engage' domain, holding sole responsibility for architectural decisions and technical direction across all systems and services.
  \item Designed and implemented event-driven architectures using Kafka and AWS EventBridge, enabling real-time data processing and system integration at scale.
  \item Established and enforced engineering excellence through comprehensive TypeScript guidelines, Clean Architecture principles, and Domain-Driven Design practices across all teams.
  \item Implemented Value Stream Management and Flow Framework methodologies to optimize delivery pipelines and enhance team productivity while reducing cognitive load.
  \item Architected and implemented advanced observability solutions using OpenTelemetry, significantly enhancing system monitoring and performance tracking capabilities.
  \item Drove technical excellence through cloud-native architectures, leveraging AWS, Kubernetes, and Kafka for robust distributed systems.
  \item Oversaw development across diverse technology stacks including Node.js, Go, C\#/.NET, and Snowflake for data warehousing solutions.
  \item Guided architectural decisions and technology choices to support the organization's growth and scalability goals.
  \end{itemize}
...
\begin{itemize}
\item Led a cross-functional team in developing and maintaining cloud-based payment solutions, fostering innovation and continuous improvement.
\item Architected and implemented scalable cloud services, ensuring high performance and security standards were met.
...
\item Drove adoption of modern software engineering practices, including microservices architecture and serverless computing.
\item Collaborated with stakeholders to define technical roadmaps, balancing immediate needs with long-term strategic goals.
\item Mentored team members, facilitating their professional growth and fostering a collaborative work environment.
\item Spearheaded the integration of DevOps practices, improving deployment frequency and reducing time-to-market for new features.
\item Stayed abreast of emerging technologies, evaluating their potential impact on the organization's cloud strategy.
\end{itemize}
...
\cvevent{B.Sc.\ in Software Engineering (Dual Degree)}{Staffordshire University}{Jan 2012 -- April 2015}{}

\divider

\cvevent{B.Sc.\ in Software Engineering (Dual Degree)}{Asia Pacific University of Technology}{Jan 2012 -- April 2015}{}

\divider

\cvevent{M.Sc.\ in Software Engineering}{Staffordshire University}{September 2015 -- Feb 2017}{}
...
\begin{itemize}
  \item \textbf{AAIS ACIS Attendance Scholarship}\\
        Australasian Association for Information Systems \hfill 2024
  \item \textbf{AMCIS 2024 Registration Scholarship}\\
        Association for Information Systems (AIS) \hfill 2024
...
\cvsection[\faSearch]{Peer Reviews}

\begin{raggedright}
Invited reviewer for 15+ international journals and conferences (22+ reviews, 2011--2024):

\vspace{0.3cm}
\textbf{Premier Journals:}
\vspace{0.4cm}
\begin{itemize}
  \item IEEE Transactions on Knowledge and Data Engineering (TKDE) 
  \item Nature Communications (Springer Nature) 
  \item IEEE Access 
  \item PeerJ Computer Science
  \item Systems Engineering (Wiley) 
  % \item Other Journals
\end{itemize}
...
\vspace{0.4cm}
\begin{itemize}
  \item ICSE 2025 - International Conference on Software Engineering
  \item ECIS - European Conference on Information Systems (2011, 2024)
  % \item Others..
\end{itemize}
\end{raggedright}
...
\begin{itemize}
  ...
  \item Other Conferences and Meetups
