...
\name{Dr. Pouya Ataei}
\tagline{Engineering Leader \& Solutions Architect (PhD in Big Data)}
...
\cvsection[\faBrain]{Executive Summary}

\begin{raggedright}
Engineering leader with 13+ years of experience architecting enterprise-scale solutions and building high-performing technical teams. Successfully transitioned from hands-on engineering to leadership roles, managing teams of 35+ engineers while maintaining deep technical expertise in Big Data, cloud platforms, and AI systems. Experienced in partnering with stakeholders to deliver business value through technical innovation, with a proven track record of scaling teams from inception to maturity. My approach combines analytical precision with creative problem-solving, always focusing on customer success and sustainable growth.
\end{raggedright}
...
\cvsection[\faHandHoldingHeart]{What I Bring to the Table}

\begin{raggedright}
• \textbf{Team Leadership}: Managing 35+ engineers across multiple teams, with experience building teams from scratch and scaling them effectively

• \textbf{Technical Depth}: PhD in Big Data with hands-on experience in distributed systems, event-driven architectures, and cloud platforms

• \textbf{Business Acumen}: Engaged with representatives from Databricks, AWS, Confluent, and other major vendors to drive architectural decisions

• \textbf{Solution Architecture}: Designed enterprise-scale systems serving millions of users with focus on performance and reliability

• \textbf{Mentorship Focus}: Passionate about developing talent, having mentored engineers from junior to senior levels throughout my career
  \end{raggedright}
...
• Building and leading teams of talented solutions architects

• Partnering with sales organizations to drive technical strategy

• Working with cutting-edge data and AI technologies

• Creating customer-focused solutions that deliver real business value

• Opportunity to shape technical culture and processes

• Balance between strategic leadership and technical involvement
...
\begin{paracol}{2}
  \cvskill{Team Leadership \& Management}{4.5}
  \divider
  \cvskill{Solution Architecture}{4.5}
  \divider
  \cvskill{Python}{4.5}
  \divider
  \cvskill{Big Data \& Data Engineering}{4.5}
  \divider
  \cvskill{AWS}{4.5}
  \divider
  \cvskill{Databricks/Spark}{4}
  \divider
  ...
  \switchcolumn
  \cvskill{React \& Frontend Architecture}{4.5}
  \divider
  \cvskill{Node/Bun/Deno}{4.5}
  \divider
  \cvskill{Golang}{3.5}
  \divider
  \cvskill{Google Cloud, Azure}{4}
  \divider
  \cvskill{SQL/NoSQL Databases}{4}
  \divider
  \cvskill{Vector Databases}{4}
  \divider
  \cvskill{Elasticsearch, MongoDB}{4}
  \divider
  \cvskill{Pre-Sales \& Technical Selling}{4}
  \divider
  \cvskill{Stakeholder Management}{4.5}
  \divider
  \cvskill{Mentoring \& Coaching}{4.5}
  \divider
  \cvskill{Agile/Scrum Methodologies}{4.5}
  \divider
  \cvskill{Technical Documentation}{4.5}
  \divider
  \cvskill{Digital Transformation}{4}
  \divider
  \end{paracol}
...
\begin{itemize}
  \item Lead the design and implementation of large-scale, serverless data architectures for ingesting, processing, and analyzing energy data from smart meters and network performance systems.
  ...
  \item Architect and deploy energy data algorithms while ensuring efficient and scalable model inference integrated with data platform services.
...
\textit{Tech \& Tools: AWS (Lambda, DynamoDB, S3, Glue, Athena), Python, Serverless Architecture, Data Engineering, Machine Learning, Event-Driven Architecture, Data Science}
...
\textit{Tech \& Tools: AWS, OpenTelemetry, Node.js, Kubernetes, Docker, Terraform, Kafka, Microservices, Python, Snowflake}
